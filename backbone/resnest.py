...
def resnest50(input_size, pretrained=False, root='~/.encoding/models', **kwargs):
...
def resnest200(input_size, **kwargs):
...
def resnest269(input_size, **kwargs):
...
def resnest50_fast(input_size, **kwargs):
    model = ResNet(input_size, Bottleneck, [3, 4, 6, 3],
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=32, avg_down=True,
...
def resnest101_fast(input_size, **kwargs):
    model = ResNet(input_size, Bottleneck, [3, 4, 23, 3],
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=64, avg_down=True,
                   avd=True, avd_first=True, **kwargs)
