...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = '../models/DenseNet201_Arcface/model', # the root to buffer your checkpoints
        LOG_ROOT = '../models/DenseNet201_Arcface/log', # the root to log your train/val status
        IS_RESUME = False,
        BACKBONE_RESUME_ROOT = "",
        HEAD_RESUME_ROOT = "",
        
        BACKBONE_NAME = 'DenseNet', # support: ['MobileFaceNet', 'ResNet_50', 'ResNet_101', 'ResNet_152', 
